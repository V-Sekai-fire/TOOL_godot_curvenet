...
/-!
# `Curvenet.SlangCodegen.DirectDeltaMush` — DDM matvec compute kernel
...
namespace Curvenet.SlangCodegen.DirectDeltaMush
...
end Curvenet.SlangCodegen.DirectDeltaMush
